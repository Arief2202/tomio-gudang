...
@section('body')
    @include('layouts.cardOpen')
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td class="d-flex justify-content-end">
                                  ...
                                  <form action="/gudang/jenis/delete" method="post" style="display: inline"> @csrf
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <form method="POST" action="/gudang/jenis/create">@csrf
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Create Jenis Baru</h1>
        ...
        <div class="modal fade" id="exampleModalUpdate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <form method="POST" action="/gudang/jenis/update">@csrf
                <input type="hidden" name="id" id="id">
                <div class="modal-header">
                  <h1 class="modal-title fs-5" id="exampleModalLabel">Update Jenis</h1>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <div class="mb-3">
...
@section('script')
    <script>
      function updateModal(id){
          ...
          xhttp.open("GET", "/get-type?id="+id, true);
          xhttp.send();
        }
